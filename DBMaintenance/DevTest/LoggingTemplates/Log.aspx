...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:SqlDataSource ID="LogAreasSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SatiTestConnectionString %>"
            ...
            <div style="display: flex; flex-direction: column;">
                <asp:Panel ID="HeaderPanel" Style="display: flex; flex-direction: column; gap: var(--UWhitespace);" runat="server">
                    ...
                    <asp:Panel runat="server" Style="display: flex; align-items: flex-start; justify-content: space-between; flex-direction: row-reverse; width: 100%;">
                        ...
                        <asp:SqlDataSource ID="ShiftSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SatiTestConnectionString %>"
                            SelectCommand="SELECT Shift FROM [SatiTest].[dbo].[fctn_GetShift]()"
                            ...
                            <div style="margin: 0 var(--UWhitespace);">
                                ...
                                <asp:Panel Visible="False" OffHandAuto="False" runat="server">
                                    <asp:DropDownList runat="server">
                                        <asp:ListItem Selected="True" Text="Select Pump..." />
                ...
                <asp:Panel runat="server" ID="FooterPanel" Style="position: fixed; bottom: 0; width: calc(100% - 20px); display: flex; flex-direction: column; gap: var(--UWhitespace);">
                    ...
                    <asp:SqlDataSource ID="CommentSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SatiTestConnectionString %>"
                        SelectCommand=""
                        UpdateCommand="UPDATE [SatiTest].[dbo].[T_LogOperatorComments] SET Comment=@Comment WHERE [Key]=@Key"></asp:SqlDataSource>
