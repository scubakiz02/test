        ...
        <asp:Panel ID="EditPreviewPanel" onscroll="setScrollPos.call(this)" runat="server" Style="display: flex; gap: var(--UWhitespace); overflow-y: auto; height: 95%; overflow-x: hidden;">
            <div>
                <asp:Panel runat="server" ID="AreaInterfacePanel" CssClass="InterfacePanel" Style="display: flex; gap: var(--UWhitespace); flex-direction: column;">
                    ...
                    <asp:SqlDataSource ID="AreaDropDownList_SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SatiTestConnectionString %>"
                        SelectCommand="SELECT A.Area, A.[Key] FROM [SatiTest].[dbo].[T_LogArea] A LEFT JOIN [SatiTest].[dbo].[T_LogAreaInterval] I ON A.IntervalKey=I.[Key] WHERE OneTimeDate IS NULL OR (OneTimeDate IS NOT NULL AND ((SELECT CompleteLog FROM [SatiTest].[dbo].[T_LogData] WHERE AreaKey=A.[Key])=0 OR (SELECT CompleteLog FROM [SatiTest].[dbo].[T_LogData] WHERE AreaKey=A.[Key]) IS NULL)) ORDER BY I.DisplayOrder, A.Active DESC, A.Assignee DESC, A.Area"></asp:SqlDataSource>
                    ...
                    <asp:SqlDataSource ID="AreaFormView_SqlDataSource" runat="server" ConflictDetection="OverwriteChanges" ConnectionString="<%$ ConnectionStrings:SatiTestConnectionString %>"
                ...
                <asp:Panel runat="server" ID="LabelInterfacePanel" CssClass="InterfacePanel" Style="display: flex; flex-direction: column; align-items: baseline; gap: var(--UWhitespace);">
                    <div style="display: flex; flex-direction: column;">
                        ...
                        <asp:SqlDataSource ID="LabelDropDownList_SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SatiTestConnectionString %>"
                    ...
                    <asp:Label ID="LabelLabel" runat="server" Text='<%# Bind("Label") %>' />
                            ...
                            <%--InsertCommand value is a select query, because it's a workaround on the asp.net architecture to prevent empty TextBox values from creating a record in DB--%>
                            <asp:SqlDataSource ID="LabelFormView_SqlDataSource" runat="server" ConflictDetection="OverwriteChanges" ConnectionString="<%$ ConnectionStrings:SatiTestConnectionString %>"
                    ...
                    <div>
                        ...
                        <br />
                            ...
                            <%--first record in table is null, to supply users the option to reset the unit--%>
                            <asp:SqlDataSource ID="UnitDropDownList_SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SatiTestConnectionString %>"
                                SelectCommand="SELECT Unit, [Key] FROM [SatiTest].[dbo].[T_LogUnit] WHERE Unit IS NOT NULL"></asp:SqlDataSource>
                        </asp:Panel>
                    </div>
            ...
            <div>
                <asp:Panel runat="server" ID="CommentInterfacePanel" CssClass="InterfacePanel">
                    ...
                    <asp:SqlDataSource ID="CommentDropDownList_SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SatiTestConnectionString %>"
                    ...
                    <asp:Label ID="CommentLabel" runat="server" Text='<%# Bind("Comment") %>' />
                        ...
                        <%--InsertCommand value is a select query, because it's a workaround on the asp.net architecture to prevent empty TextBox values from creating a record in DB--%>
                        <asp:SqlDataSource ID="CommentFormView_SqlDataSource" runat="server" ConflictDetection="OverwriteChanges" ConnectionString="<%$ ConnectionStrings:SatiTestConnectionString %>"
                ...
                <asp:Button Text="Create" runat="server" Enabled="False" />
                    ...
                    <%--InsertCommand value is a select query, because it's a workaround on the asp.net architecture to prevent empty TextBox values from creating a record in DB--%>
                    <asp:SqlDataSource ID="StampFormView_SqlDataSource" runat="server" ConflictDetection="OverwriteChanges" ConnectionString="<%$ ConnectionStrings:SatiTestConnectionString %>"
                ...
                <div class="InterfacePanel" style="display: flex; flex-direction: column; gap: var(--UWhitespace);">
                    <asp:Panel runat="server" Enabled="false" ID="DepartmentInterfacePanel">
                        ...
                        <asp:SqlDataSource ID="DepartmentDropDownList_SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SatiTestConnectionString %>"
                            SelectCommand="SELECT Department, [Key] FROM [SatiTest].[dbo].[T_LogDepartment]"></asp:SqlDataSource>
                    ...
                    <asp:Panel runat="server" ID="IntervalInterfacePanel" Style="display: flex; flex-direction: column; gap: var(--UWhitespace);">
                        <div style="display: flex; flex-direction: column;">
                            ...
                            <asp:SqlDataSource ID="IntervalDropDownList_SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SatiTestConnectionString %>"
                                SelectCommand="SELECT Interval, [Key] FROM [SatiTest].[dbo].[T_LogAreaInterval] ORDER BY DisplayOrder"></asp:SqlDataSource>
                        </div>
