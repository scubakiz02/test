...
Partial Class PC_WafertoryMove
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        If e.CommandName = "Wafertory" Then
    ...
    Sub SaveNewExcelFile(ByVal FLEX As FlexCel.XlsAdapter.XlsFile)
        ...
        Dim ExcelSave As String

        ExcelSave = "\\PWI-40\TempImageWebFiles$\" & FileName
        ...
        Saticode.OpenNewPage(Me.UpdatePanel1, Session("ReportFolder") & FileName)
