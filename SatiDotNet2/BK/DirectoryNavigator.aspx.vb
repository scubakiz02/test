...
Partial Class DirectoryNavigator
    ...
    Protected Sub ProLogsRB_CheckedChanged(sender As Object, e As EventArgs) Handles ProLogsRB.CheckedChanged
        ...
        End If
    End Sub
    Protected Sub BackPageButton_Clicked(sender As Object, e As EventArgs) Handles BackPageButton.Click
        ...
        If BackPath = "\\PWI-40\docshare" Then
        ...
        If FormsRB.Checked = True Then
            ResetRadioButton()
            FormsRB.Checked = True
        ElseIf ProceduresRB.Checked = True Then
            ResetRadioButton()
            ProceduresRB.Checked = True
        ElseIf WorkInstructionRB.Checked = True Then
            ResetRadioButton()
            WorkInstructionRB.Checked = True
        ElseIf MiscLabelsRB.Checked = True Then
            ResetRadioButton()
            MiscLabelsRB.Checked = True
        ElseIf RecipesRB.Checked = True Then
            ResetRadioButton()
            RecipesRB.Checked = True
        ElseIf ProLogsRB.Checked = True Then
            ResetRadioButton()
            ProLogsRB.Checked = True
        End If
    End Sub
