    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:Panel ID="ProductionLogPanel" runat="server" Width="1000px">
                <table>
                    <tr>
                        <td style="align-content: center; height: 40px; width: 1003px;">
                    ...
                    <tr>
                        <td style="width: 1003px; height: 300px;">
                            <asp:Panel ID="ProLogoptionPanel" runat="server" BackColor="LightGray" Width="1003px" Height="330px">
                                <table border="0">
                                    <tr>
                                                ...
                                                <tr>
                                                    <td style="padding-left: 50px; width: 460px; height: 60px">
                                                        ...
                                                        <asp:DropDownList ID="DepartmentDropDown" runat="server" Width="165px" AutoPostBack="True">
                                                            ...
                                                            <asp:ListItem>Center Thickness</asp:ListItem>
                                        ...
                                        <td style="width: 492px; height: 250px; align-content: center">
                                            <table style="width: 488px; height: 274px;">
                                                ...
                                                <tr>
                                                    <td style="text-align: center; height: 55px; padding-left:18px; padding-top: 10px">
                                                        <asp:Panel ID="VerifyPanel" runat="server" HorizontalAlign="Center" BackColor="#507CD1">
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="OperatorCheckLabel" runat="server" Text="Please ensure all three inputs (Shifts, Department, and Date) are correct" Font-Size="Medium" ForeColor="white"></asp:Label>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <asp:Button ID="OperatorCheckButton" runat="server" Text="Continue?" Font-Size="Medium" Font-Bold="true" BackColor="Black" ForeColor="White" BorderStyle="Groove" Width="150" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </asp:Panel>
                    ...
                    <tr>
                        <td style="width: 1000px">
                            <asp:Panel ID="TaskLabelPanel" runat="server" BackColor="LightGray" Width="1003px" Height="25">
                                <table>
                                    <tr>
                            ...
                            <asp:Panel ID="ShiftPanel" runat="server" Width="1000px" HorizontalAlign="Center">
                                <table>
                                    <tr>
                                        <td style="width: 1003px; padding-top: 10px">
                                            <asp:GridView ID="ProLogTablePre" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Key" DataSourceID="SqlDataSourceProLogLotsPre" ForeColor="#333333" AutoPostBack="True" ShowFooter="True" Width="1000px" ShowHeaderWhenEmpty="True" GridLines="None">
                                            ...
                                            <br />
                                            <asp:GridView ID="ProLogTableCurrent" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Key" DataSourceID="SqlDataSourceProLogLots" ForeColor="#000066" AutoPostBack="True" Width="1000px" ShowHeaderWhenEmpty="True" GridLines="None">
                                                <AlternatingRowStyle BackColor="White" />
                                                <Columns>
                                                    <asp:BoundField DataField="Key" HeaderText="Key" SortExpression="Key" ReadOnly="True" InsertVisible="False"></asp:BoundField>
                                                    ...
                                                    <asp:BoundField DataField="StartTime" HeaderText="StartTime" SortExpression="StartTime" DataFormatString="{0:g}" ControlStyle-Width="140px"/>
                                                    <asp:BoundField DataField="EndTime" HeaderText="EndTime" SortExpression="EndTime" DataFormatString="{0:g}" ControlStyle-Width="140px"/>
                                            ...
                                            <asp:Panel ID="AddNewRecord" runat="server" Width="1000px" Height="70px" BackColor="#000066">
                                                <table style="width: 1000px; height: 70px; background-color: #000066;">
                                                    <tr>
                                                        <td style="height: 35px; width: 250px">
                                                            <table style="width: 250px">
                                                                ...
                                                                <tr style="justify-content: right">
                                                                    <td style="height: 10px; width: 135px;"></td>
                                                                    <td>
                    ...
                    <tr>
                        <td style="width: 1003px; padding-bottom: 50px">
                            <asp:Panel ID="PrologErrorMessages" runat="server" HorizontalAlign="Center" BackColor="LightGray" Height="30px">
                                <table style="width: 1003px; align-content: center">
                                    <tr>
                                        <td style="width: 1003px; align-content: center; height: 23px;">
                                            <asp:Label ID="PrologError" runat="server" Text=""></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </asp:Panel>
                            <asp:Panel ID="Spacer" runat="server" HorizontalAlign="Center" BackColor="LightGray" Height="30px">
                            </asp:Panel>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Panel ID="DownTimeLabelPanel" runat="server" BackColor="LightGray" Height="25px" Style="padding-top: 0px">
                                <table>
                                    <tr>
                                        <td style="width: 1000px; text-align: center">
                            ...
                            <asp:Panel ID="DownTimePanel" runat="server" Width="1000px" HorizontalAlign="Center">
                                <table>
                                    <tr>
                                        <td style="width: 1003px; padding-top: 10px">
                                            <asp:GridView ID="ProLogDTPre" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSourceProLogDTPre" ForeColor="#333333" Width="1000px" DataKeyNames="Key" ShowFooter="True" ShowHeaderWhenEmpty="True" GridLines="None">
                                                <AlternatingRowStyle BackColor="White" />
                                                <Columns>
                                                    <asp:BoundField DataField="Key" HeaderText="Key" SortExpression="Key" ReadOnly="true" InsertVisible="False"></asp:BoundField>
                                                    <asp:BoundField DataField="Shift" HeaderText="Shift" SortExpression="Shift"></asp:BoundField>
                                            ...
                                            <br />
                                            <asp:GridView ID="ProLogDTCurrent" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSourceProLogDT" ForeColor="#333333" Width="1000px" ShowHeaderWhenEmpty="True" GridLines="None" DataKeyNames="Key">
                                                <AlternatingRowStyle BackColor="White" />
                                                <Columns>
                                            ...
                                            <asp:Panel ID="AddNewDTRecord" runat="server" Width="997px" Height="70" HorizontalAlign="Left">
                                                <table style="width: 1000px; height: 50px; background-color: Black; padding-left: 2px">
                                                    <tr>
                        ...
                        <td style="width: 1000px; padding-top: 10px">
                            <asp:Panel ID="ErrorMessagePanel" runat="server" HorizontalAlign="Center" BackColor="LightGray" Height="30px">
                                <table style="width: 1000px; align-content: center">
                                    <tr>
                                        <td style="width: 1000px; align-content: center; height: 23px;">
