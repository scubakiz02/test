<%@ Page Language="VB" MasterPageFile="~/MasterPage1.master" AutoEventWireup="false" CodeFile="LabelRemakeWCurrentOldStyle.aspx.vb" Inherits="Production_LabelRemakeWCurrentOldStyle" title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="X-Large" Text='200mm Or Less Wafer Box Label Reprint "Current"'></asp:Label><br />
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="Panel2" runat="server" Width="408px">
                ...
                <asp:Panel ID="WBScanPanel" runat="server" Visible="False" Width="240px">
                    Scan 200mm or &lt; Wafer Box label<br />
