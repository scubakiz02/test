<%@ Page Language="VB" MasterPageFile="~/MasterPage1.master" AutoEventWireup="false" CodeFile="ChecklistLoggingMainMaint.aspx.vb" Inherits="DBMaintenance_DBMaintenanceMain" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Panel ID="Panel1" runat="server">
        ...
        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/ChecklistLogging/ChecklistReport.aspx">Report Checklist</asp:HyperLink><br />
        <br />
