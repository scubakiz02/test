<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage1.master" AutoEventWireup="true" CodeFile="ScheduledMaintReqTicket.aspx.vb" Inherits="MR_MRT" %>
                ...
                <tr>
                    <td colspan="3" style="height: 23px;">
                        ...
                        <table class="MasterPagePanelSub">
                            <tr>
                                <td>&nbsp;<asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="X-Large" Text="Scheduled Maintenance Request"></asp:Label></td>
                                <td style="text-align: right">&nbsp;<asp:Button ID="Button2" runat="server" Text="View SMRs" BackColor="#FFFF99" PostBackUrl="~/SMR/SMR_Viewer.aspx" /></td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td colspan="3" style="height: 53px">&nbsp;<asp:Button ID="Button1" runat="server" Text="Submit" /><br />
                        <div>
                            ...
                            <asp:HyperLink ID="SMR_ViewerRedirect_Hyperlink" runat="server" />
                        </div>
                    </td>
                </tr>
