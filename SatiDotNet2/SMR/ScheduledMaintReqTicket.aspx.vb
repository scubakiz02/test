...
Partial Class MR_MRT
    ...
    Sub Submit()
        ...
        TicketNumber = SatiCode.ScheduledMaintenanceRequestTicket("New", "0", tool)



        Try
            SatiCode.ScheduledMaintenanceRequestNote(TicketNumber, "Org", Me.ProblemTextBox.Text & TAGs)
            ...
            Me.infoLabel.Text = "Your Request Was Submited. Your Ticket Number is " & TicketNumber & ". To finish ticket details, click "
            SMR_ViewerRedirect_Hyperlink.NavigateUrl = "SMR_Viewer.aspx"
            SMR_ViewerRedirect_Hyperlink.Text = "here"
