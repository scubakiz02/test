...
Partial Class MR_OpenTicketStatusBoard
    ...
    Sub Build()
        ...
        DS = SatiCode.GetMyDataSet("SELECT TOP (100) PERCENT dbo.T_IT_Tools.Department, dbo.T_IT_Tools.Tool, dbo.Q_ITR_Open.MR_Key, dbo.Q_ITR_Open.[Ticket Type], dbo.Q_ITR_Open.NoteType, dbo.Q_ITR_Open.Note, dbo.Q_ITR_Open.IssueDate FROM dbo.T_IT_Tools LEFT OUTER JOIN dbo.Q_ITR_Open ON dbo.T_IT_Tools.[Key] = dbo.Q_ITR_Open.Tool WHERE (dbo.T_IT_Tools.UpTimeReport = 1) GROUP BY dbo.T_IT_Tools.Department, dbo.T_IT_Tools.Tool, dbo.Q_ITR_Open.MR_Key, dbo.Q_ITR_Open.[Ticket Type], dbo.Q_ITR_Open.NoteType, dbo.Q_ITR_Open.Note, dbo.Q_ITR_Open.IssueDate  ORDER BY dbo.T_IT_Tools.Department, dbo.T_IT_Tools.Tool, dbo.Q_ITR_Open.MR_Key")
