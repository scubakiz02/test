<%@ Page Language="VB" MasterPageFile="~/MasterPage1.master" AutoEventWireup="false" CodeFile="OpenTickets.aspx.vb" Inherits="MR_OpenTickets" Title="Untitled Page" %>
        ...
        <ContentTemplate>
            <asp:Panel ID="NotePanel" runat="server" Width="1009px" Visible="True">
                ...
                <table cellspacing="0" style="vertical-align: top; text-align: left;">
                    <tr>
                        <td style="text-align: left;">&nbsp;MR#&nbsp;<asp:Label ID="LabelMRNumber" runat="server" Text="Label"></asp:Label>&nbsp;</td>
                        ...
                        <td style="text-align: center; font-weight: bold;">&nbsp;Ticket Type:&nbsp;
                            ...
                            <asp:Label ID="LabelStatus" runat="server" Text="Label" Visible="False"></asp:Label>&nbsp; </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="display: none;">&nbsp;Ok For Report?&nbsp;<asp:CheckBox ID="CheckBoxReport" runat="server"
                ...
                <asp:SqlDataSource ID="NotesSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ALTSConnectionString %>"
                    SelectCommand="SELECT NoteDate, SatiUser, Note FROM dbo.T_MR_TicketNotes WHERE (MR_Key = 10) AND (NoteType = 'Tech')"></asp:SqlDataSource>

                <asp:SqlDataSource ID="SqlDataSourceReport" runat="server"
                    ConnectionString="<%$ ConnectionStrings:ALTSConnectionString %>"
                    DeleteCommand="DELETE FROM [T_MR_Tickets] WHERE [MR_Key] = @MR_Key"
                    InsertCommand="INSERT INTO [T_MR_Tickets] ([ReportOK]) VALUES (@ReportOK)"
                    SelectCommand="SELECT MR_Key, ReportOK FROM dbo.T_MR_Tickets WHERE (MR_Key = 10)"
                    UpdateCommand="UPDATE [T_MR_Tickets] SET [ReportOK] = @ReportOK WHERE [MR_Key] = @MR_Key">
                    <DeleteParameters>
                        <asp:Parameter Name="MR_Key" Type="Int32" />
                    </DeleteParameters>
                    <UpdateParameters>
