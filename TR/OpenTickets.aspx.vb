...
Partial Class MR_OpenTickets
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Me.IsPostBack = False Then
            ...
            ds = SatiCode.GetMyDataSet("SELECT CloseDate FROM dbo.T_ITR_Tickets WHERE (MR_Key = " & MR_Key & ")") 'SELECT CloseDate FROM dbo.T_ITR_Tickets WHERE (MR_Key = 53868)
    ...
    Protected Sub SubmitButton_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Else
            SatiCode.ITRequestNote(MR_Key, "Tech", Me.NewNoteTextBox.Text)
    ...
    Sub BuildSQL()
        ...
        MyDS = SatiCode.GetMyDataSet("SELECT dbo.T_ITR_Tickets.MR_Key AS Ticket#, dbo.T_IT_Tools.Tool, dbo.T_ITR_Tickets.Status, dbo.T_ITR_TicketNotes.Note, dbo.T_ITR_Tickets.IssueDate, dbo.T_ITR_Tickets.IssueUser, dbo.T_ITR_Tickets.CloseDate, dbo.T_ITR_Tickets.CloseUser, dbo.T_ITR_Tickets.ReportOK FROM dbo.T_ITR_Tickets INNER JOIN dbo.T_IT_Tools ON dbo.T_ITR_Tickets.Tool = dbo.T_IT_Tools.[Key] INNER JOIN dbo.T_ITR_TicketNotes ON dbo.T_ITR_Tickets.MR_Key = dbo.T_ITR_TicketNotes.MR_Key WHERE (dbo.T_ITR_TicketNotes.NoteType = 'Org') AND (dbo.T_ITR_Tickets.MR_Key = '" & MR_Key & "')")
        ...
        BuildNotes = "SELECT NoteDate, SatiUser, Note FROM dbo.T_ITR_TicketNotes WHERE (MR_Key = '" & MR_Key & "') AND (NoteType = 'Tech')"
    ...
    Protected Sub CloseButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles CloseButton.Click
        ...
        If Me.GridView1.Rows.Count > 0 Then
            ...
            Me.infoLabel.Text = ""
            'BuildSQL()
            SatiCode.ITRequestTicket("Close", MR_Key, 0, "")
            Response.Redirect("MR_Viewer.aspx")
        Else
    ...
    Protected Sub CheckBoxReport_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxReport.CheckedChanged
        ...
        SatiCode.GetMyDataSet("UPDATE dbo.T_ITR_Tickets SET ReportOK = " & MyVal & " WHERE MR_Key = " & MR) 'UPDATE dbo.T_ITR_Tickets SET ReportOK = 1 WHERE MR_Key = 4057
        BuildSQL()
    End Sub
    ...
    Protected Sub DropDownListStatus_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DropDownListStatus.SelectedIndexChanged
        SatiCode.ITRequestTicket("ModStatus", MR_Key, 0, Me.DropDownListStatus.SelectedValue.ToString)
